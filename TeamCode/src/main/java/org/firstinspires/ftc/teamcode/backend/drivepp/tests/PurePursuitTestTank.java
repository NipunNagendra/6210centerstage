...
import org.firstinspires.ftc.teamcode.backend.drivepp.PurePursuitConstants;
...
//        forwardPower *= Math.cos(Range.clip(AngleUnit.normalizeRadians(targetPose.heading-robotPose.heading), -Math.PI / 2, Math.PI / 2));
        ...
        forwardPower = Range.clip(forwardPower, -PurePursuitConstants.MAX_TRANSLATIONAL_SPEED, PurePursuitConstants.MAX_TRANSLATIONAL_SPEED);
        turnPower = Range.clip(turnPower, -PurePursuitConstants.MAX_ROTATIONAL_SPEED, PurePursuitConstants.MAX_ROTATIONAL_SPEED);

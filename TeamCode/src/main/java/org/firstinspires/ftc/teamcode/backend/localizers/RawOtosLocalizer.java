...
public class RawOtosLocalizer {
    ...
    public Pose getPose() {
        ...
        return new Pose(pos.x, pos.y, pos.h);
    }
    ...
    public Pose[] getPosVelAcc(){
        ...
        myOtos.getPosVelAcc(otosPose,otosVel,otosAcc);

        return new Pose[]{new Pose(otosPose.x, otosPose.y, otosPose.h),
                new Pose(otosVel.x, otosVel.y, otosVel.h),
                new Pose(otosAcc.x, otosAcc.y, otosAcc.h)};
    }
    ...
    public void configureOtos() {
        ...
        SparkFunOTOS.Pose2D offset = new SparkFunOTOS.Pose2D(-1.75, -6.5, 0);
